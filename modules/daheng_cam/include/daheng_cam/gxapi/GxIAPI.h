...
typedef enum GX_STATUS_LIST {
  ...
  GX_STATUS_INVALID_PARAMETER = -5,  ///< Invalid parameter. Generally, the pointer is NULL or the input IP and other
                                     ///< parameter formats are invalid
...
typedef enum GX_FEATURE_ID {
  ...
  GX_ENUM_TEST_PATTERN =
      1017 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Selects the type of test pattern that is generated by
  ...
  GX_INT_PAYLOAD_SIZE =
      2000 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Provides the number of bytes transferred for each image
  ...
  GX_INT_GEV_PACKETSIZE = 2006 | GX_FEATURE_INT |
                          GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Specifies the stream packet size, in bytes, to send on the
                                                        ///< selected channel for a GVSP transmitter or specifies the
                                                        ///< maximum packet size supported by a GVSP receiver.
  ...
  GX_ENUM_TRIGGER_SOURCE =
      3013 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Specifies the internal signal or physical input Line
  ...
  GX_ENUM_LINE_SELECTOR =
      4004 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Selects the physical line (or pin) of the external
  ...
  GX_ENUM_LINE_SOURCE =
      4007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Selects which internal acquisition or I/O source
  ...
  GX_INT_AWBROI_OFFSETY =
      6023 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< This value sets the Y offset (top offset) for the rect
                                                            ///< of interest for Auto WhiteBalance
  GX_INT_AWBROI_WIDTH =
      6024 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< This value sets the width of the rect of interest in
                                                            ///< pixels for Auto WhiteBalance
  GX_INT_AWBROI_HEIGHT =
      6025 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< This value sets the height of the rect of interest in
                                                            ///< pixels for Auto WhiteBalance
  ...
  GX_COMMAND_USER_SET_LOAD =
      7001 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Loads the User Set specified by UserSetSelector to
  ...
  GX_BUFFER_LUT_VALUEALL =
      9001 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Accesses all the LUT coefficients in a single access
  ...
  GX_ENUM_COUNTER_EVENT_SOURCE =
      ...
      GX_FEATURE_LEVEL_REMOTE_DEV,  ///< Select the events that will be the source to increment the Counter, Refer to
...
typedef struct GX_DEVICE_IP_INFO {
  ...
  char
      szNICMAC[GX_INFO_LENGTH_32_BYTE];  ///< the MAC address of the corresponding NIC(Network Interface Card), 32 bytes
...
typedef struct GX_OPEN_PARAM {
  char *pszContent;  ///< Standard C string that is decided by openMode. It could be an IP address, a camera serial
                     ///< number, and so on
  GX_OPEN_MODE_CMD
...
\param      [out] punNumDevices   The address pointer used to return the number of devices, and the pointer can not be
NULL. \param      [in] unTimeOut        The timeout time of enumeration (unit: ms). If the device is successfully
...
\return     GX_STATUS_SUCCESS               The operation is successful and no error occurs.
            GX_STATUS_NOT_INIT_API          The GXInitLib initialization library is not called.
            GX_STATUS_INVALID_HANDLE        The handle that the user introduces is illegal.
            GX_STATUS_INVALID_CALL          After registering the capture callback function, the user calls the
GXGetImage to get image. GX_STATUS_INVALID_PARAMETER     User incoming image address pointer is NULL.
            GX_STATUS_NEED_MORE_BUFFER      Insufficient buffer requested by the user: When reading,the user
                                            input buffer size is smaller than the actual need.
            The errors that are not covered above please reference GX_STATUS_LIST.
*/
...
\param      [in]featureID           The feature code ID.
\param      [out]pHCallBack         The handle of property update callback function, to unregister the callback
function. \return     GX_STATUS_SUCCESS               The operation is successful and no error occurs.
            GX_STATUS_NOT_INIT_API          The GXInitLib initialization library is not called.
            GX_STATUS_INVALID_HANDLE        The handle that the user introduces is illegal.
            GX_STATUS_INVALID_PARAMETER     The unsupported event ID or the callback function is illegal.
            The errors that are not covered above please reference GX_STATUS_LIST.
